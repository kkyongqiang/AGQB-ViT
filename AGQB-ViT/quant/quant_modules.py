...
from .quantizer import UniformQuantizer,  SoftmaxLogQuantizer,GELULogQuantizer
...
class QuantLinear(nn.Linear):
    ...
    def __init__(self,
        ...
        if 'log_quant' in input_quant_params_linear:
            ...
            self.input_quantizer= GELULogQuantizer(**input_quant_params_linear)
        else:
...
class QuantMatMul(nn.Module):
    ...
    def __init__(self,
        ...
        if 'log_quant' in input_quant_params_matmul:
            ...
            self.quantizer_A = SoftmaxLogQuantizer(**input_quant_params_matmul)
        else:
